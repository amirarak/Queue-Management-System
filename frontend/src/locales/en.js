export default {
  ...
  staffMgmt: {
    ...
    emailNote:    'Staff member will receive an email with a temporary password',
  ...
  forgotPassword: {
    ...
    description: 'Enter your corporate email — we will send a verification code.',
    emailRequired: 'Email is required',
    ...
    passwordPolicy: 'Password must contain uppercase, lowercase, and a number',
