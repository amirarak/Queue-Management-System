...
export const queueAPI = {
  ...
  getCurrent(departmentId) {
    return api.get('/queue/current', { params: { departmentId } })
  },
  callNext(departmentId) {
    return api.post('/queue/call-next', { departmentId })
  },
  complete(id, notes) {
    return api.put(`/queue/${id}/complete`, { notes })
  },
  getHistory(params) {
